                ...
                if (!$(this).hasClass("active")) {
                    ...
                    $(".J_mainContent .J_iframe").each(function() {
                        if ($(this).data("id") == o) {
                            ...
                            $(this).show().attr("src",o); //再次点击后刷新已经打开的iframe页面
                        }
                    });

                }
                //再次点击左侧菜单后刷新当前打开的iframe页面
                $(".J_mainContent .J_iframe").each(function() {
                    if ($(this).data("id") == o) {
                        $(this).show().siblings(".J_iframe").hide();
                        $(this).show().attr("src",o); //再次点击后刷新已经打开的iframe页面
 ...
 * @returns {boolean}
 */
function appOpen(url,title) {
    var o = url,
        m = Date.parse(new Date()),
        l = title,
        k = true;
    if (o == undefined || $.trim(o).length == 0) {
        return false
 ...
 * 关闭当前窗口
 */
function appCloseActive() {
    $(".J_menuTab.active").find('.fa-times-circle').click()
}